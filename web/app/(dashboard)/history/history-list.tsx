...
export function HistoryList({ analyses: initial }: { analyses: AnalysisSummary[] }) {
    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">{analyses.length} {lang === 'tr' ? 'analiz' : 'analyses'}</p>
        </div>
        <Link href="/analyze"
