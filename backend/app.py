            ...
            try:
                ...
                if image_count > 0:
                    ...
                    en_prompt = (
                        ...
                        "Impression:\n"
                        "List differential diagnoses as bullet points in this exact format:\n"
                        "• [Diagnosis name] — [X%]: [key supporting radiological evidence]\n"
                        "Order from most to least likely. Probabilities must sum to 100%. "
                        "Include 3–6 differentials. Clearly flag (URGENT) any finding requiring emergent attention. "
                        "Correlate with provided clinical history where applicable.\n\n"
                    ...
                    text_only_prompt = (
                        ...
                        "Impression:\n"
                        "List differential diagnoses as bullet points in this exact format:\n"
                        "• [Diagnosis name] — [X%]: [key supporting evidence]\n"
                        "Order from most to least likely. Probabilities must sum to 100%. "
                        "Include 3–6 differentials. Clearly flag (URGENT) any finding requiring urgent attention.\n\n"
                ...
                tr_prompt = (
                    ...
                    "Yorum:\n"
                    "Öneri:\n\n"
                    "ÖNEMLI: Yorum bölümündeki madde işaretli liste formatını koru. "
                    "Her satır '• [Tanı adı] — [X%]: [kanıt]' biçiminde kalmalıdır. "
                    "Yüzde değerlerini ve madde işaretlerini (•) olduğu gibi bırak. "
